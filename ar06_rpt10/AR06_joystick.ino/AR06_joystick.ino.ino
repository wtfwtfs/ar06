...
void loop(){
  ...
  if(xValue>400)digitalWrite(bGo,LOW);
  else digitalWrite(bGo,HIGH);
  delay(100);

  if(xValue<600)digitalWrite(rStop,LOW);
  else digitalWrite(rStop,HIGH);
  delay(100);

  if(yValue>450)digitalWrite(yLeft,HIGH);
  else digitalWrite(yLeft,LOW);
  delay(100);

  if(yValue<350)digitalWrite(yRight,HIGH);
  else digitalWrite(yRight,LOW);
  delay(100);

  if(zValue == LOW)digitalWrite(wShoot,HIGH);
